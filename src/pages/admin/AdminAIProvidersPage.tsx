    ...
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={openCreate}
          className="rounded bg-[var(--accent-primary)] px-4 py-2 text-sm font-medium text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[var(--accent-primary)]"
        >
          Add provider
        </button>
      </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block text-sm">
              ...
              <input
                ...
                className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-[var(--accent-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-primary)]"
              />
            </label>
            <label className="block text-sm">
              ...
              <select
                ...
                disabled={!!editingId}
                className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-[var(--accent-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-primary)] disabled:bg-gray-100"
              >
