    ...
    <AdminShell>
              ...
              <div
                ...
                className={`max-w-[75%] rounded-lg px-4 py-2 text-sm ${
                  m.message_type === 'user'
                    ...
                    : 'bg-[var(--color-mint)] text-gray-900'
                }`}
              >
                {m.content}
              </div>
      ...
      {hasMore && (
        <button
          ...
          className="mt-4 rounded border px-4 py-2 text-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]"
        >
          Load more
        </button>
      )}
